...
const Footer = () => {
    return (
        ...
        <div className="footer__option-wrapper">
         ...
         <h3 className="footer__option-blurb"><img src={iconFb} alt="Facebook"/></h3>
         <h3 className="footer__option-blurb"><img src={iconIns} alt="Instagram"/></h3>    
         <h3 className="footer__option-blurb"><img src={iconTw} alt="Twitter"/></h3>        
         </div>
         </div>
         <div  className="footer__copy">
             <h3 className="footer__copy-text">&#169; Fusion Inc. All Rights Reserved.</h3>
         </div>
